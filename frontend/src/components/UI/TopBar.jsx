              ...
              {isOpen && (
                <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden z-50">
                  ...
                  <div
                    ...
                    className="p-4 cursor-pointer border-b border-gray-100 dark:border-gray-700 bg-gradient-to-r from-[var(--primary-color)]/10 to-[var(--primary-dark)]/10"
                  >
                    <div className="flex items-center gap-3">
                      <img
                        src={user?.profilePic || "/default-avatar.png"}
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500 hover:underline dark:text-gray-400 truncate">
                          {user.email}
                        </p>
                      </div>
                    </div>
